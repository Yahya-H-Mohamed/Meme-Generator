function clearAll() {
  const memeContainer = 
        document.querySelector("#meme-box");
  const jokeContainer = 
        document.querySelector("#joke-box");
  const quoteContainer = 
        document.querySelector("#quote-box");
  const riddleContainer = 
        document.querySelector("#riddle-box");
...
function showMeme() {
  ...
  const container = document.querySelector("#meme-box");
...
function showJoke() {
  ...
  const container = document.querySelector("#joke-box");
...
function showRiddle() {
  ...
  const container = document.querySelector("#riddle-box");
  ...
  riddleAnswer.textContent = "The answer is: " + randomRiddle.answer;
  
  clearAll();
  
  container.appendChild(riddleQuestion);
  container.appendChild(riddleAnswer);
}
